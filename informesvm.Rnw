...
<<train,results=tex,echo=FALSE>>=
library(xtable)
tabla.train<-read.table("tabla.train.txt")
colnames(tabla.train)<-(1:6)
print(xtable(tabla.train,digits=4,
...
<<test,results=tex,echo=FALSE>>=

tabla.test<-read.table("tabla.test.txt")
colnames(tabla.test)<-(1:6)
print(xtable(tabla.test,digits=4,
...
<<sdtrain,results=tex,echo=FALSE>>=

tabla.sdtrain<-read.table("tabla.sdtrain.txt")
colnames(tabla.sdtrain)<-(1:6)
print(xtable(tabla.sdtrain,digits=4,
...
tabla.sdtest<-read.table("tabla.sdtest.txt")
colnames(tabla.sdtest)<-(1:6)
print(xtable(tabla.sdtest,digits=4,
